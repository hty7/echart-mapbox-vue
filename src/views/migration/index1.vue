<template>
  <section class="permanent">
    ...
    <div class="permanent-mapStyle">
      <ButtonGroup shape="circle" size="small" class="permanent-mapStyle-content" v-show="show">
        <Button type="primary" @click="mapStyleTogger('mapbox/satellite-v9')">
        ...
        <Button type="primary" @click="mapStyleTogger('mapbox/dark-v9')">
          <Poptip trigger="hover" placement="bottom">
            <Icon type="ios-world-outline"></Icon> dark地图
            <div slot="content">
              <img src="static/img/mapstyle-dark.png"/>
            </div>
          </Poptip>
        </Button>
        <Button type="primary" @click="mapStyleTogger('yangjian/cjc1fhogi0gcz2rocfn4vd9xg')">
          <Poptip trigger="hover" placement="bottom">
        ...
        series: [
          ...
          // },
          {
            ...
            data: [
              ...
              [[113.475995, 23.417055], [113.475995, 23.417055]],
